...
const ArrayOFF = 
   [{ label: "Ordinary non breakable product", value: "Ordinary non breakable product" },
   { label: "Drink are breakable product", value: "Drink are breakable product" },
   { label: "Telephone and computer", value: "Telephone and computer" },
   { label: "Other product", value: "Other product" }];
 
// const ArrayOFF = Array.from(Array(4).keys());
const CategoryArray=ArrayOFF.map(ls=>{
  return {lable:ls.label,value:ls.value}
})
console.log("The Catagory arraay is:",CategoryArray)
// const CategoryArray = ArrayOFF.map(arrayOFF => {

//   return [{ label: , value: arrayOFF }];
// });
      ...
      <div className='newContainer'>
        ...
        >
          <div className='text-div'>
            ...
            >
              {console.log("It is in te component",CategoryArray)}
            ...
            onChange={event => setPrice(event.target.value)}
            helperText="Delivery price"
          />
          <TextField
            required
            id="outlined-required"
            label="Maximum quantity delivery price"
            value={NewPrice}
            onChange={event => setNewPrice(event.target.value)}
            helperText="Maximum quantity delivery price"
          />
        ...
        <Stack spacing={2} direction="row">
          ...
          <Button variant="contained" onClick={SubmiteData} id='btn'>Add Product</Button>
