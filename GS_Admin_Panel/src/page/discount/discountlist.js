...
export default function StoreDiscount() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (querySnapshot) => {
      ...
      setArray(querySnapshot.docs.map(d => d.data().Discount))
      console.log("querySnapshot.docs.map(d => d.data().Discount",querySnapshot.docs.map(d => d.data().Discount))
    });
  }, [])
  return (
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Percentage Value</StyledTableCell>
