  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row'}}>
        ...
        <View style={styles.LeftcontainerSecond}>
          <Text style={styles.LeftcontainerSecondText}>Statut actuel</Text>
          <Text style={styles.LeftcontainerSecondSubText}>Actif</Text>
          <TouchableOpacity style={styles.ButtonStyle} onPress={()=>props.navigation.navigate('ResturantAddress')}>
        <Text style={styles.ButtonStyleText}>Passer inactif</Text>
      </TouchableOpacity>
        </View>
      </View>
